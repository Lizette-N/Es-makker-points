...
Opret en Firestore-database og deploy reglerne fra `firestore.rules`. Spil identificeres med et tilfældigt link; alle med linket kan oprette og redigere runder. Hele spil kan slettes fra spiloversigten efter en bekræftelse.
